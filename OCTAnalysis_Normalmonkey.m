...
pause(0.01);
%% Load OCT image;
%os:[FileName, FilePath] = uigetfile({'*.bmp'},'Select data informations','E:\文章撰写\斜视猴子\normal monkey\OCT\Repeat2\');
[FileName, FilePath] = uigetfile({'*.bmp'},'Select data informations','E:\文章撰写\斜视猴子\normal monkey\OCT\Right\');
...
imshow(adapthisteq(OCTData(1:500,500:1264), 'NumTiles',[20 20], 'ClipLimit',0.01,'NBins',100,'Distribution','exponential','Alpha',0.5))
